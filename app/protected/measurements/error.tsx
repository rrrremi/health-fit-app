...
/**
 * Error boundary for measurements page
 * Catches errors and provides recovery options
 */
export default function MeasurementsError({ error, reset }: ErrorProps) {
  useEffect(() => {
    // Log to Sentry
      ...
      <div className="max-w-md w-full">
        <div className="rounded-lg border border-red-500/20 bg-red-500/10 p-6 backdrop-blur-sm">
          ...
          <p className="text-sm text-white/60 text-center mb-6">
            We encountered an error while loading your measurements. This might be a temporary issue.
          </p>
