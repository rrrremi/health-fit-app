-- ============================================================================
-- ADD HEALTHY REFERENCE RANGES TO METRICS CATALOG
-- ============================================================================
-- Add gender-specific healthy reference ranges for accurate status indicators
-- Replaces broad min_value/max_value with medically accurate healthy ranges
-- ============================================================================

-- Add healthy reference range columns
...
COMMENT ON COLUMN metrics_catalog.healthy_min_male IS 'Lower bound of healthy reference range for males';
COMMENT ON COLUMN metrics_catalog.healthy_max_male IS 'Upper bound of healthy reference range for males';
COMMENT ON COLUMN metrics_catalog.healthy_min_female IS 'Lower bound of healthy reference range for females';
COMMENT ON COLUMN metrics_catalog.healthy_max_female IS 'Upper bound of healthy reference range for females';

-- ============================================================================
-- UPDATE EXISTING METRICS WITH ACCURATE HEALTHY RANGES
-- ============================================================================
-- Based on standard medical reference ranges for healthy adults
-- Sources: Mayo Clinic, NIH, WHO, standard lab reference ranges
-- ============================================================================

-- Body Composition (gender-specific where applicable)
...
-- Blood Lipids (gender-specific for some)
UPDATE metrics_catalog SET
...
-- Blood Pressure (same for both genders)
UPDATE metrics_catalog SET
...
-- Vitals (gender-specific where applicable)
UPDATE metrics_catalog SET
...
-- Thyroid (gender-specific for some)
UPDATE metrics_catalog SET
...
-- Hormones (highly gender-specific)
UPDATE metrics_catalog SET
